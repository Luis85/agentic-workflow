...
| **Issue-breakdown** *(opt-in)* | `.claude/agents/issue-breakdown.md` | Post-/spec:tasks. Decompose GitHub issue into draft PRs from `tasks.md`. Read-only on `specs/`. | [`docs/issue-breakdown-track.md`](docs/issue-breakdown-track.md) ([ADR-0022](docs/adr/0022-add-issue-breakdown-track.md)) |
