...
Skills (`.claude/skills/`) are reusable how-tos any agent can invoke (`verify`, `new-adr`, `review-fix`). Four workflow-conductor skills (`orchestrate`, `discovery-sprint`, `stock-taking`, `project-run`) provide the conversational entry points.
