...
Skills (`.claude/skills/`) are reusable how-tos any agent can invoke (`verify`, `new-adr`, `review-fix`). Three workflow-conductor skills (`orchestrate`, `discovery-sprint`, `project-run`) provide the conversational entry points.
