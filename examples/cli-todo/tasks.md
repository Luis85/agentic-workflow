...
The example decomposes implementation into small, traceable work units. Test-oriented tasks come before implementation completion for the same behavior.

### T-CLI-001 — Scaffold binary and command dispatcher
...
### T-CLI-002 — Add dispatcher and help tests
...
### T-CLI-003 — Implement path resolution and storage read validation
...
### T-CLI-004 — Add storage and path tests
...
### T-CLI-005 — Implement atomic save
...
### T-CLI-006 — Add atomic-write tests
...
### T-CLI-007 — Implement task commands
...
### T-CLI-008 — Add command behavior tests
