...
| [`arc42-baseline/`](arc42-baseline/SKILL.md) | "Arc42", "12-factor check", "fill the questionnaire", SaaS-shaped feature | User or orchestrator, *before* `/spec:design` (stage 4); the `architect` reads the answered questionnaire as canonical input for Part C |
