...
| [0027](0027-adopt-shape-b-branching-model.md) | Adopt Shape B branching model (develop / main / demo) for the template | Accepted |
...
| [0034](0034-expose-specorator-scripts-as-cli-binary.md) | Expose specorator scripts as a CLI binary via bin entry in the existing package | Accepted |
| [0035](0035-add-issue-draft-track.md) | Add issue-draft track for early draft PR and living PRD from /spec:idea | Proposed |
