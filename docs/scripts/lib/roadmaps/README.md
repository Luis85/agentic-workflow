---
title: "lib/roadmaps"
folder: "docs/scripts/lib/roadmaps"
description: "Entry point for generated API reference for the lib/roadmaps script helper module."
entry_point: true
---
...
[agentic-workflow](../../modules.md) / lib/roadmaps
...
- [roadmapDocuments](variables/roadmapDocuments.md)
- [roadmapDocumentStatuses](variables/roadmapDocumentStatuses.md)
- [roadmapScopeTypes](variables/roadmapScopeTypes.md)
- [roadmapStatuses](variables/roadmapStatuses.md)
