...
[@luis85/agentic-workflow](../../../modules.md) / [lib/release-package-contract](../README.md) / INTAKE\_FOLDERS

# Variable: INTAKE\_FOLDERS

> `const` **INTAKE\_FOLDERS**: readonly `string`[]
