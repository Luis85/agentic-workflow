...
folder: "docs"
description: "Generated reference list of Claude Code slash commands shipped by Specorator."
---
# Slash Command Inventory

Claude Code users can invoke these commands directly. Non-Claude users should treat this page as a reference for the stage, track, or operation to reproduce manually with the relevant Markdown artifacts.
