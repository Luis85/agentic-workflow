...
| `issues/` | Canonical local mirror of feature issue tracking. | `issues/README.md` only (or absent). No `issues/<number>-<slug>.md`. Per [ADR-0031](adr/0031-adopt-issues-folder-for-canonical-issue-tracking.md). |
