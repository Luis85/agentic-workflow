...
### 2026-05-02 — T-V05-004 — Add release readiness check
...
### 2026-05-02 — T-V05-005 — Test release readiness behavior
...
### 2026-05-02 — T-V05-006 — Add manual GitHub Release workflow
...
### 2026-05-02 — T-V05-007 — Add package publish path
...
### 2026-05-02 — T-V05-008 — Add release operator guide
...
### 2026-05-02 — T-V05-009 — Update public distribution docs
...
### 2026-05-02 — Review fix — Codex round-8 P3 on PR #161 (chunk-doc input count)
...
### 2026-05-02 — Review fix — Codex round-7 P1 + P3 on PR #161 (explicit tag SHA + workflow-state alignment)
...
### 2026-05-02 — Review fix — Codex round-6 P3 ×2 on PR #161 (input count + rerun semantics)
...
### 2026-05-02 — Review fix — Codex round-5 P2 + P3 on PR #161 (smoke-test auth + Layer-2 quick-check archive)
...
### 2026-05-02 — Review fix — Codex round-4 P2 on PR #161 (subshell-scoped credentials)
...
### 2026-05-02 — Review fix — Codex round-3 P2 on PR #161 (trap-based credential cleanup)
...
### 2026-05-02 — Review fix — Codex round-2 P1 ×2 on PR #161 (manual recovery — npm auth + non-E404 branch)
...
### 2026-05-02 — Review fix — Codex round-1 P1 ×2 on PR #161 (rollback path + rerun guidance)
...
### 2026-05-02 — Review fix — Codex round-4 P1 on PR #160 (npm view error handling)
...
### 2026-05-02 — Review fix — Codex round-3 on PR #160 (idempotent publish + contract clarification)
...
### 2026-05-02 — Review fix — Codex P2 on PR #160 (lockfile shipping)
...
### 2026-05-02 — Review fix — Codex P1 on PR #160
...
### 2026-05-02 — T-V05-010 + T-V05-011 — Release dry run and readiness verification
