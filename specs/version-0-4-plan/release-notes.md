...
- **Public release documentation** — README §Roadmap row v0.4 flipped to Done with this release; release notes substantively edited (T-V04-009; PRs #163 / #168).
...
- **Release-time conditions — all closed:**
  - T-V04-009 §Changes cross-checked against the final list of merged PRs (#137, #138, #148, #149, #152, #166, #168, #169, #170, #171). README §Roadmap row v0.4 flipped to "Done" with this release-tag PR. `docs/specorator.md` v0.4 references reviewed — no version-specific references to update.
