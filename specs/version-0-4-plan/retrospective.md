...
| Done 2026-05-02: `scripts/quality-metrics.ts` reads `npm_config_feature`, so `npm run quality:metrics --feature=<slug>` no longer silently falls back to repository scope. Tracked by #189. | tooling | dev | 2026-06-15 |
